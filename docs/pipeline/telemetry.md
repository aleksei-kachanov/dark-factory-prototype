...
| Dev iterations | Number of `dotnet test` runs before developer-agent DoD (1 = first-pass green) |
...
| Issue | Date | Plan tests specified | Plan tests skipped | Critic rounds | Dev iterations | Supplementary tests | Reviewer verdict | Reviewer findings fixed | Notes |
|-------|------|---------------------|--------------------|---------------|----------------|---------------------|-----------------|------------------------|-------|
